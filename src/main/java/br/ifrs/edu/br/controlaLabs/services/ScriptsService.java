...
public class ScriptsService {
	public static String lerCaminhoScript(String lab, String acao) {
        ...
        if (lab.equalsIgnoreCase("labling") && acao.equalsIgnoreCase("liberar")) script="/system script run app-libera-labling";        
        ...
        if (lab.equalsIgnoreCase("labling") && acao.equalsIgnoreCase("bloquear")) script = "/system script run app-bloqueia-labling";
        ...
        if (lab.equalsIgnoreCase("labling") && acao.equalsIgnoreCase("default")) script ="/system script run app-default-labling";
